...
ma3 = GNB3.score(X_90,y_90)
print(f'The mean accuracy of the training evaluation model(hold-out) in is : {ma3:.3f}') # 0.615(unscaled)
ma3b = GNB3.score(X_eval,y_eval)
print(f'The mean accuracy of the testing evaluation model(hold-out) in is : {ma3b:.3f}')# 0.519, 0.643



# GNB4 = GaussianNB()
# ma4 = mean(cross_val_score(GNB4, X_eval, y_eval, scoring = 'accuracy'))
# print(f'The mean cross-val accuracy of the evaluation model in is : {ma4:.3f}') 
