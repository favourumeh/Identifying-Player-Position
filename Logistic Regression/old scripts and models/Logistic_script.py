...
#(Repeating with df_90 (not stacked train-test) C = 29.7635 for mean accuracy (0.6934; 2nd place) and log loss (0.750615; 1st place)
a = []
b = []
...
#(Repeating with df_90 (not stacked train-test): C =29.7635 for mean accuracy (0.681408; 2nd place) and log loss (0.775022; 2nd place)
...
y_pred = log_reg_eval1.predict(X_s)
...
Pred_prob_df = pd.DataFrame(log_reg_eval1.predict_proba(X_s), columns = list(log_reg_eval1.classes_))
